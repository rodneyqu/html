...
if($database=='GeneIntro'){
	$query="UPDATE GeneIntro SET Status=0,ReviewDate=\"$ReviewDate\",GeneIntr_cn=\"$VariantDesc_cn\" WHERE GeneIntroID=\"$ID\"";
...
if($database=='Therapy_Test'){
	$query="UPDATE TherapyEfficacy SET Status=0,ReviewDate=\"$ReviewDate\",TherapyEfficacy_cn=\"$VariantDesc_cn\" WHERE TherapyID=\"$ID\"";
