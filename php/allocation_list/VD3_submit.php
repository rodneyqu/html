...
if($database=='VariantDesc'){
	$query1="UPDATE VariantDesc SET Status=1,VariantDesc_cn=\"$Translation\",Count=Count+1,TranslatorID=\"$TranslatorID\",ReviewerID=\"$ReviewerID\",AllocationDate=\"$ApproveDate\",TranslationDate=\"$TranslationDate\",ReviewDate=\"$ReviewDate\",Priority=\"$Priority\" WHERE VariantDescID=\"$ID\";";
...
if($database=='GeneIntro'){
	$query1="UPDATE GeneIntro SET Status=1,GeneIntr_cn=\"$Translation\",Count=Count+1,TranslatorID=\"$TranslatorID\",ReviewerID=\"$ReviewerID\",AllocationDate=\"$ApproveDate\",TranslationDate=\"$TranslationDate\",ReviewDate=\"$ReviewDate\",Priority=\"$Priority\" WHERE GeneIntroID=\"$ID\"";
...
if($database=='Therapy_Test'){
	$query1="UPDATE TherapyEfficacy SET Status=1,TherapyEfficacy_cn=\"$Translation\",Count=Count+1,TranslatorID=\"$TranslatorID\",ReviewerID=\"$ReviewerID\",AllocationDate=\"$ApproveDate\",TranslationDate=\"$TranslationDate\",ReviewDate=\"$ReviewDate\",Priority=\"$Priority\" WHERE TherapyID=\"$ID\"";
