...
$query3="SELECT GeneIntro.GeneIntroID,Gene.Symbol,GeneIntro.Count,GeneIntro.Status,GeneIntro.GeneIntr_en FROM GeneIntro JOIN Gene ON GeneIntro.GeneID=Gene.GeneID WHERE GeneIntro.GeneIntroID=\"$ID\"-1283";
if(empty($query3)){
