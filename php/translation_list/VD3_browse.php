...
if($database=='VariantDesc'){
    $query1="SELECT VariantDesc.VariantDescID,Gene.Symbol,Variant.HGVSp,VariantDesc.Count,VariantDesc.Status,VariantDesc.VariantDesc_en FROM VariantDesc JOIN Variant ON VariantDesc.VariantID=Variant.VariantID JOIN Transcript ON Transcript.TranscriptID=Variant.TranscriptID JOIN Gene ON Gene.GeneID=Transcript.GeneID WHERE VariantDesc.VariantDescID=\"$ID\"";
...
if($database=='GeneIntro'){
    $query3="SELECT GeneIntro.GeneIntroID,Gene.Symbol,GeneIntro.Count,GeneIntro.Status,GeneIntro.GeneIntr_en FROM GeneIntro JOIN Gene ON GeneIntro.GeneID=Gene.GeneID WHERE GeneIntro.GeneIntroID=\"$ID\"";
...
if($database=='Therapy_Test'){
    $sql='select TherapyID,Keyword,TherapyEfficacy_en,`Status`,CreateDate,Count,TranslationDate from TherapyEfficacy where TherapyID='.$ID;
